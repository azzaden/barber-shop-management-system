...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">المبلغ المكتسب من الخدمات</h4>
<h4 align="center" style="color:blue"> من تاريخ <?php echo $m1."-".$y1;?> <br> حتى تاريخ <?php echo $m2."-".$y2;?></h4>
<hr />
...
<tr>
                  <td colspan="2" align="center">المجموع </td>
...
$y2=date("Y",$year2);
 ?>
 <h4 class="header-title m-t-0 m-b-30">المبلغ المكتسب من الخدمات</h4>
    <h4 align="center" style="color:blue">من تاريخ <?php echo $y1;?><br> حتى تاريخ <?php echo $y2;?></h4>
    <hr />
    <table class="table table-bordered">  <thead>
<tr>
<th>S.NO</th>
