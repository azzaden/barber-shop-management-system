...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">تفاصيل البحث عن تقرير</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>التقارير بين تاريخ</h4>
 <?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];

?>
<h5 align="center" style="color:blue">تفارير من <?php echo $fdate?> الى <?php echo $tdate?></h5>
...
?>
						 ...
						 <tr> 
						 	...
						 	<td><?php  echo $row['PostingDate'];?></td> 
						 		<td><a href="view-invoice.php?invoiceid=<?php  echo $row['BillingId'];?>">عرض التفاصيل</a></td> 
